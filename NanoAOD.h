...
// Fri Oct 20 06:06:38 2017 by ROOT version 6.08/07
// from TTree Events/Events
// found on file: /hadoop/cms/store/user/namin/NanoAODv1/ProjectMetis/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8_RunIISummer17MiniAOD-92X_upgrade2017_realistic_v10_ext1-v1_MINIAODSIM_NanoAODv1/merged_ntuple_1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           FatJet_subJetIdx3[6];   //[nFatJet]
   UInt_t          nGenJet;
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[169];   //[nGenPart]
   Float_t         GenPart_phi[169];   //[nGenPart]
   Float_t         GenPart_pt[169];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[169];   //[nGenPart]
   Int_t           GenPart_pdgId[169];   //[nGenPart]
   Int_t           GenPart_status[169];   //[nGenPart]
   UInt_t          nGenVisTau;
   ...
   Int_t           GenVisTau_pdgId[4];   //[nGenVisTau]
   Int_t           GenVisTau_status[4];   //[nGenVisTau]
   Float_t         genWeight;
   Float_t         LHEWeight_originalXWGTUP;
   UInt_t          nLHEPdfWeight;
   Float_t         LHEPdfWeight[50];   //[nLHEPdfWeight]
   ...
   Float_t         Jet_btagDeepBB[30];   //[nJet]
   ...
   Float_t         SubJet_btagDeepBB[12];   //[nSubJet]
   ...
   Float_t         Tau_footprintCorr[6];   //[nTau]
   ...
   Float_t         TrigObj_filterBits[38];   //[nTrigObj]
   ...
   Bool_t          HLT_PFMET120_PFMHT120_IDTight_HFCleaned;
   Bool_t          HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_HFCleaned;
   Bool_t          HLT_PFMETTypeOne120_PFMHT120_IDTight_HFCleaned;
   Bool_t          HLT_PFMET120_PFMHT120_IDTight_PFHT60_HFCleaned;
   ...
   TBranch        *b_FatJet_btagDeepBB;   //!
   TBranch        *b_FatJet_btagHbb;   //!
   TBranch        *b_FatJet_eta;   //!
   TBranch        *b_FatJet_mass;   //!
   TBranch        *b_FatJet_mpruned;   //!
   ...
   TBranch        *b_HLT_PFMET120_PFMHT120_IDTight_HFCleaned;   //!
   TBranch        *b_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_HFCleaned;   //!
   TBranch        *b_HLT_PFMETTypeOne120_PFMHT120_IDTight_HFCleaned;   //!
   TBranch        *b_HLT_PFMET120_PFMHT120_IDTight_PFHT60_HFCleaned;   //!
...
#ifdef NanoAOD_cxx
NanoAOD::NanoAOD(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hadoop/cms/store/user/namin/NanoAODv1/ProjectMetis/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8_RunIISummer17MiniAOD-92X_upgrade2017_realistic_v10_ext1-v1_MINIAODSIM_NanoAODv1/merged_ntuple_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hadoop/cms/store/user/namin/NanoAODv1/ProjectMetis/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8_RunIISummer17MiniAOD-92X_upgrade2017_realistic_v10_ext1-v1_MINIAODSIM_NanoAODv1/merged_ntuple_1.root");
      }
...
Int_t NanoAOD::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NanoAOD::LoadTree(Long64_t entry)
{
...
void NanoAOD::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("FatJet_btagDeepBB", FatJet_btagDeepBB, &b_FatJet_btagDeepBB);
   fChain->SetBranchAddress("FatJet_btagHbb", FatJet_btagHbb, &b_FatJet_btagHbb);
   fChain->SetBranchAddress("FatJet_eta", FatJet_eta, &b_FatJet_eta);
   fChain->SetBranchAddress("FatJet_mass", FatJet_mass, &b_FatJet_mass);
   fChain->SetBranchAddress("FatJet_mpruned", FatJet_mpruned, &b_FatJet_mpruned);
   ...
   fChain->SetBranchAddress("FatJet_subJetIdx3", FatJet_subJetIdx3, &b_FatJet_subJetIdx3);
   ...
   fChain->SetBranchAddress("GenVisTau_pdgId", GenVisTau_pdgId, &b_GenVisTau_pdgId);
   ...
   fChain->SetBranchAddress("Jet_btagDeepBB", Jet_btagDeepBB, &b_Jet_btagDeepBB);
   ...
   fChain->SetBranchAddress("SubJet_btagDeepBB", SubJet_btagDeepBB, &b_SubJet_btagDeepBB);
   ...
   fChain->SetBranchAddress("HLT_PFMET120_PFMHT120_IDTight_HFCleaned", &HLT_PFMET120_PFMHT120_IDTight_HFCleaned, &b_HLT_PFMET120_PFMHT120_IDTight_HFCleaned);
   fChain->SetBranchAddress("HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_HFCleaned", &HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_HFCleaned, &b_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_HFCleaned);
   fChain->SetBranchAddress("HLT_PFMETTypeOne120_PFMHT120_IDTight_HFCleaned", &HLT_PFMETTypeOne120_PFMHT120_IDTight_HFCleaned, &b_HLT_PFMETTypeOne120_PFMHT120_IDTight_HFCleaned);
   fChain->SetBranchAddress("HLT_PFMET120_PFMHT120_IDTight_PFHT60_HFCleaned", &HLT_PFMET120_PFMHT120_IDTight_PFHT60_HFCleaned, &b_HLT_PFMET120_PFMHT120_IDTight_PFHT60_HFCleaned);
...
void NanoAOD::Show(Long64_t entry)
{
...
Int_t NanoAOD::Cut(Long64_t entry)
{
